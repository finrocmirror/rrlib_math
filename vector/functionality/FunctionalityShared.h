...
public:
  ...
  template <typename TOtherElement>
  inline const math::tVector < Tdimension, decltype(TElement() + TOtherElement()), TData, TAdditionalDataParameters... > Projected(const math::tVector<Tdimension, TOtherElement, TData, TAdditionalDataParameters...> &other) const __attribute__((always_inline));
