...
const math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, Symmetrical> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, TRightData> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > tResult;
  typename tResult::tElement data[Trows * Tcolumns];
...
const math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, Symmetrical> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, LowerTriangle> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > tResult;
  typename tResult::tElement data[Trows * Tcolumns];
  std::memset(data, 0, sizeof(data));
...
template <size_t Trows, size_t Tconnection, size_t Tcolumns, typename TLeftElement, typename TRightElement>
const math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, Symmetrical> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, UpperTriangle> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > tResult;
  typename tResult::tElement data[Trows * Tcolumns];
  std::memset(data, 0, sizeof(data));
...
const tVector < Trows, decltype(TMatrixElement() + TVectorElement()), vector::Cartesian > operator *(const math::tMatrix<Trows, Tcolumns, TMatrixElement, Symmetrical> &matrix, const tVector<Tcolumns, TVectorElement, vector::Cartesian> &vector)
{
...
template <size_t Trows, size_t Tcolumns, typename TMatrixElement, typename TVectorElement>
const tVector < Tcolumns, decltype(TMatrixElement() + TVectorElement()), vector::Cartesian > operator *(const tVector<Trows, TVectorElement, vector::Cartesian> &vector, const math::tMatrix<Trows, Tcolumns, TMatrixElement, Symmetrical> &matrix)
{
