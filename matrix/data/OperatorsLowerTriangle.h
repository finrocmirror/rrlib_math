...
//
//----------------------------------------------------------------------
/*!\file    rrlib/math/matrix/data/OperatorsLowerTriangle.h
 *
...
const typename boost::disable_if < boost::is_same<LowerTriangle<1, 1, int>, TRightData<1, 1, int>>, math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > >::type operator + (const math::tMatrix<Trows, Tcolumns, TLeftElement, LowerTriangle> &left, const math::tMatrix<Trows, Tcolumns, TRightElement, TRightData> &right)
{
...
const math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > operator + (const math::tMatrix<Trows, Tcolumns, TLeftElement, LowerTriangle> &left, const math::tMatrix<Trows, Tcolumns, TRightElement, UpperTriangle> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > tResult;
  typename tResult::tElement data[Trows * Tcolumns];
  size_t index = 0;
...
const math::tMatrix < Trows, Tcolumns, decltype((TLeftElement() * TRightElement()) + (TLeftElement() * TRightElement())), LowerTriangle > operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, LowerTriangle> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, LowerTriangle> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype((TLeftElement() * TRightElement()) + (TLeftElement() * TRightElement())), LowerTriangle > tResult;
...
const typename boost::disable_if < boost::is_same<LowerTriangle<1, 1, int>, TRightData<1, 1, int>>, math::tMatrix < Trows, Tcolumns, decltype((TLeftElement() * TRightElement()) + (TLeftElement() * TRightElement())), Full > >::type operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, LowerTriangle> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, TRightData> &right)
{
...
const tVector < Trows, decltype((TMatrixElement() * TVectorElement()) + (TMatrixElement() * TVectorElement())), vector::Cartesian > operator *(const math::tMatrix<Trows, Tcolumns, TMatrixElement, LowerTriangle> &matrix, const tVector<Tcolumns, TVectorElement, vector::Cartesian> &vector)
{
...
template <size_t Trows, size_t Tcolumns, typename TMatrixElement, typename TVectorElement>
const tVector < Tcolumns, decltype((TVectorElement() * TMatrixElement()) + (TVectorElement() * TMatrixElement())), vector::Cartesian > operator *(const tVector<Trows, TVectorElement, vector::Cartesian> &vector, const math::tMatrix<Trows, Tcolumns, TMatrixElement, LowerTriangle> &matrix)
{
