...
const math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), LowerTriangle > operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, LowerTriangle> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, LowerTriangle> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), LowerTriangle > tResult;
...
const typename boost::disable_if < boost::is_same<LowerTriangle<1, 1, int>, TRightData<1, 1, int> >, math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > >::type operator *(const math::tMatrix<Trows, Tconnection, TLeftElement, LowerTriangle> &left, const math::tMatrix<Tconnection, Tcolumns, TRightElement, TRightData> &right)
{
  typedef math::tMatrix < Trows, Tcolumns, decltype(TLeftElement() + TRightElement()), Full > tResult;
  typename tResult::tElement data[Trows * Tcolumns];
  std::memset(data, 0, sizeof(data));
...
const tVector < Trows, decltype(TMatrixElement() + TVectorElement()), vector::Cartesian > operator *(const math::tMatrix<Trows, Tcolumns, TMatrixElement, LowerTriangle> &matrix, const tVector<Tcolumns, TVectorElement, vector::Cartesian> &vector)
{
...
template <size_t Trows, size_t Tcolumns, typename TMatrixElement, typename TVectorElement>
const tVector < Tcolumns, decltype(TMatrixElement() + TVectorElement()), vector::Cartesian > operator *(const tVector<Trows, TVectorElement, vector::Cartesian> &vector, const math::tMatrix<Trows, Tcolumns, TMatrixElement, LowerTriangle> &matrix)
{
